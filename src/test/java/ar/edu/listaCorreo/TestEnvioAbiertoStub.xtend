...
import ar.edu.listaCorreoSimple.envioMails.ImprimirPorConsola
...
class TestEnvioAbiertoStub {
	...
	@Test
	@DisplayName("Podemos simular el envío de dos mails decorando la interfaz aunque no tengamos implementación")
